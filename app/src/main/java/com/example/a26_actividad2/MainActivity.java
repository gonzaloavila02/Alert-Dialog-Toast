package com.example.a26_actividad2;
                    ...
                    */
                    ...
                    if (numeroMostrado % 4 == 0 && (numeroMostrado % 100 != 0 || numeroMostrado % 400 == 0)){
                        if(BotonSi.isChecked()){
                            ...
                            MyAlert.setTitle("La aplicación ha terminado");
                            MyAlert.setMessage("¿Desea continuar jugando?");
                            MyAlert.setPositiveButton("Continuar",null);
                            MyAlert.setNegativeButton("Terminar", new DialogInterface.OnClickListener() {
                                @Override
                            ...
                            AlertDialog cuadro = MyAlert.create();
                            cuadro.show();
                        ...
                        if(botonNo.isChecked()){
                            ...
                            if(BotonSi.isChecked()){
                                ...
                                text_resultado.setTextColor(Color.parseColor("#FF3700B3"));
                                text_resultado.setText("Debes marcar alguna de las dos opciones");
                            }
                        }
